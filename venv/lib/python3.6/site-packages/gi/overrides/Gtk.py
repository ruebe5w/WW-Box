...
if Gtk._version in ("2.0", "3.0"):
    class Table(Gtk.Table, Container):
        ...
        def attach(self, child, left_attach, right_attach, top_attach, bottom_attach,
                   ...
                   yoptions=Gtk.AttachOptions.EXPAND | Gtk.AttachOptions.FILL, xpadding=0, ypadding=0):
            Gtk.Table.attach(self, child, left_attach, right_attach, top_attach, bottom_attach, xoptions, yoptions,
                             xpadding, ypadding)
