...
class App(BaseHTTPRequestHandler, object):
    ...
    def _instance(self):
        ...
        net_interface_ip = self.headers.get('Host',
    ...
    def __init__(self, server_address, RequestHandlerClass,
        ...
        if self.ssl_version != None:
            self.socket = ssl.wrap_socket(self.socket, keyfile=self.keyfile, certfile=self.certfile, server_side=True,
                                          ssl_version=self.ssl_version, do_handshake_on_connect=True)
...
def start(main_gui_class, **kwargs):
    ...
    if standalone:
        return StandaloneServer(main_gui_class, start=True, **kwargs)
    else:
        return Server(main_gui_class, start=True, **kwargs)
